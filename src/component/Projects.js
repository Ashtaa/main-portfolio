...
function Projects({theme}) {
  return (
    <div className={`project-container ${theme}`}>
       <div className='img-container' data-aos='fade-left'><a href='https://ablack-6e21c.web.app/'><img src={ecommerce} className='project-img'  alt="e commerce" /></a>
       <h3 className='h3' data-aos='fade-up'>e commerce</h3>
       ...
       <div className='img-container' data-aos='fade-right'><a href='https://ashtaa.github.io/coursera/'><img src={coursera} className='project-img'  alt="coursera" /></a>
       <h3 className='h3 'data-aos='fade-up'>final project</h3>
       ...
       <div className='img-container' data-aos='fade-down'><a href='https://ashtaa.github.io/weather/'><img src={weather} className='project-img'  alt="weather" /></a>
       <h3 className='h3' data-aos='fade-up'>weather</h3>
